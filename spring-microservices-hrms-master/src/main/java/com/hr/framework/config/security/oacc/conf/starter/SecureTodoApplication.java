...
package com.hr.framework.config.security.oacc.conf.starter;
...
import com.hr.framework.config.security.oacc.conf.starter.auth.OaccBasicAuthenticator;
import com.hr.framework.config.security.oacc.conf.starter.auth.OaccPrincipal;
import com.hr.framework.config.security.oacc.conf.starter.core.TodoItemService;
import com.hr.framework.config.security.oacc.conf.starter.core.TodoUserService;
import com.hr.framework.config.security.oacc.conf.starter.db.TodoItemDAO;
import com.hr.framework.config.security.oacc.conf.starter.db.TodoUserDAO;
import com.hr.framework.config.security.oacc.conf.starter.resources.TodoItemResource;
import com.hr.framework.config.security.oacc.conf.starter.resources.TodoUserResource;
import com.hr.framework.config.security.oacc.conf.starter.resources.exceptions.AuthorizationExceptionMapper;
import com.hr.framework.config.security.oacc.conf.starter.resources.exceptions.IllegalArgumentExceptionMapper;
import com.hr.framework.config.security.oacc.conf.starter.resources.exceptions.InvalidCredentialsExceptionMapper;
import com.hr.framework.config.security.oacc.conf.starter.resources.exceptions.NotAuthenticatedExceptionMapper;
